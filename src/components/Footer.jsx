...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-white bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]">

      {/* Background Blur */}
      <div className="absolute top-10 right-0 h-56 w-56 sm:h-72 sm:w-72 rounded-full bg-[#ff2a2a]/10 blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-16 md:py-24">
        ...
        >
          ...
          <div className="flex flex-col gap-3 text-center md:text-left">
            <h4 className="text-xs sm:text-sm font-black uppercase tracking-[0.3em] text-black/40">
              Services
            </h4>

            <p className="text-black/70">Full Stack Development</p>
            <p className="text-black/70">Frontend Developer</p>
            <p className="text-black/70">Backend Developer</p>
            <p className="text-black/70">API Architecture</p>
          </div>
          ...
          <div className="flex flex-col gap-3 items-center">
            ...
            <a
              href="#projects"
              className="text-black/70 underline hover:text-black transition-colors underline-offset-4"
            >
              Projects
            </a>
          ...
          <div className="flex flex-col gap-3 text-center md:text-right">
            ...
            <a
              href="mailto:rohitrahul2909@gmail.com"
              className="text-black/70 underline hover:text-black transition-colors underline-offset-4 break-all"
            >
              rohitrahul2909@gmail.com
            </a>

            <p className="text-black/70">Worldwide Available</p>
          </div>
        </div>
        ...
        <div
          data-aos="zoom-in"
          className="flex justify-center items-center py-10 sm:py-14 md:py-20 overflow-hidden"
        >
          <h2 className="text-[22vw] sm:text-[18vw] md:text-[16vw] leading-none font-black tracking-tighter lowercase bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent select-none text-center">
            Rahul
          </h2>
        </div>
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          <p className="text-center text-xs sm:text-sm font-black uppercase tracking-[0.3em] text-black/40 mb-6 md:mb-8">
            Built With
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6">
            {techStack.map((tech, index) => (
              <div
                ...
                data-aos="zoom-in"
                data-aos-delay={index * 80}
                className="group rounded-xl sm:rounded-2xl border border-black/10 bg-white p-3 sm:p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
              >
                <img
                  src={tech.image}
                  alt={tech.name}
        ...
        <div
          data-aos="fade-up"
          className="border-t border-black/10 pt-6 md:pt-8 flex flex-col md:flex-row items-center justify-between gap-3 text-center"
        >
          <p className="text-xs sm:text-sm text-black/40">
            © {new Date().getFullYear()} Rahul. All rights reserved.
          </p>

          <p className="font-mono text-[10px] sm:text-xs tracking-widest text-black/40">
